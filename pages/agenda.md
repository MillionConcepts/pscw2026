...
**Submissions by early career researchers and topics of timely and emerging interest to planetary scientists will be prioritized for talk and poster slots.** We anticipate fewer presentation opportunities than attendees.[^1] Our objective is to expose all workshop participants to the breadth, depth, and diversity of issues facing the (broad, deep, and diverse) field of planetary science, to develop a shared understanding of collective challenges, so that we can try to tackle them together.

[^1]: Note, however, that _all_ accepted abstracts and proceedings contributions---whether or not they are selected for an in-person presentation opportunity---will be archived on Zenodo and indexed by ADS.